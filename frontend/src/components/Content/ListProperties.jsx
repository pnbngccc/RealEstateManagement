...
// //         `http://localhost:5000/api/property-detail`
// //       );
// //       console.log("Property Details Response:", response.data); // Add this line
...
// //                         detail.idProperty._id === property._id
// //                     );
// //                     console.log("Property ID:", property._id); // Log ID của bất động sản
// //                     console.log("Property Detail:", propertyDetail); // Log thông tin chi tiết của bất động
// //                     return (
// //                       <div className="property-item" key={property._id}>
// //                         <a href={`/properties/${property._id}`} className="img">
// //                           <img
                      ...
                      <a href={`/properties/${property._id}`} className="img">
                        <div className="image-gallery">
                          {property.images && property.images.length > 0 ? (
                            <img
                              src={property.images[0]} // Chỉ lấy ảnh đầu tiên
                              alt={property.title || "Hình ảnh bất động sản"}
                              className="img-fluid"
                              style={{
                                display: "block",
